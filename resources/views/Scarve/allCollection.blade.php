    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black text-primary display-4" href="index-scarve"href="index">NeedeaneScarve</a></span>
            </div>
...
<form  method="GET" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            <div class="column1">
                <img src="{{ asset('images/'.$model->prod_image) }}" width="500" alt="Product Image">
            </div>

            <!-- Second Column: Other Details -->
            <div class="column2">
                <p><strong>Product Name:</strong> {{ $model->prod_name }}</p>
                <p><strong>Price:</strong> {{ $model->prod_price }}</p>
                <p><strong>Description:</strong> {{ $model->prod_desc }}</p>
                <p><strong>Quantity:</strong> {{ $model->prod_quantity }}</p>

                @csrf
            <a class="btn btn-primary" href="{{route('viewOrder-product',['id'=>$model->prod_id]) }}">Add to cart</a>
            </div>
        </div>
    </form>
